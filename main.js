...
$(function(){
    let numbOfItems = $(".list .item").length;
    let limitPerPage = 10;
    let totalPages = Math.ceil(numbOfItems / limitPerPage);
    ...
    function showPage(whichPage){
        ...
        $(".list .item").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
